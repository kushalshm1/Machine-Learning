...
'''This is the main logistic regression class which contains functions such as Train and Test

So all you need to do is to enter your dataset address in double quotes while creating an object

of Logistic Regession class, the code to do that is as follows:

lr = LogisticRegression()
lr.train("Data Address","Iterations","Learning Rate")

And believe me your machine will be trained.
This lr.train() function will return thetas which you can input to lr.test() function along with 
your feature matrix on which you want to test and this is how you can easily 
train your machine to classify.
'''
class LogisitcRegression:
	...
	def test(self,weights,features):
		sig = 0
